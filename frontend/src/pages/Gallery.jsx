...
const Gallery = () => {
    ...
    const [activeFilter, setActiveFilter] = useState(location.state?.category || 'Semua');
    ...
    return (
        <div className="bg-white min-h-screen text-text-primary pb-12">
            ...
            <section className="relative pt-28 pb-16 overflow-hidden bg-surface">
                        ...
                        <div className="w-full md:w-2/5 p-6 md:p-8 flex flex-col relative bg-white">
                            ...
                            <div className="mt-4 mb-auto pr-14 md:pr-0">
                                ...
                                <div className="space-y-8">
                                    <h4 className="text-[11px] uppercase tracking-widest font-bold text-primary border-b border-border pb-4 font-sans">Detail Koleksi</h4>
                                    <div className="flex justify-between text-[11px] uppercase tracking-widest font-bold text-text-muted font-sans">
                                        <span>Gaya Desain</span>
                                        <span className="text-text-primary">Era Jahit Premium</span>
                                    </div>
                                    <div className="flex justify-between text-[11px] uppercase tracking-widest font-bold text-text-muted font-sans">
                                        <span>Estimasi Konsultasi</span>
                                        <span className="text-text-primary">3-5 Hari Kerja</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-8">
                                ...
                                }} className="w-full flex items-center justify-center gap-4 py-5 bg-primary text-white uppercase tracking-widest text-xs font-bold rounded-xl hover:bg-primary-dark transition-all shadow-xl shadow-primary/20">
