...
import { Mail, MapPin, Map, PhoneCall, Clock, MessageCircle, ChevronRight } from 'lucide-react';
        ...
        <section className="bg-white py-32" id="contact">
            <div className="container mx-auto px-4 md:px-12">
                <div className="text-center mb-24 animate-fade-in">
                    ...
                    <h2 className="text-5xl md:text-7xl font-display font-bold mb-8 leading-tight text-text-primary">
                        Konsultasi Gratis
                    </h2>
                    <p className="text-text-secondary text-lg max-w-2xl mx-auto leading-relaxed font-body">
                        ...
                        Tim Era Jahit siap membantu Anda.
                    </p>
                </div>
                        ...
                        <div className="space-y-6">
                            <div className="bg-surface p-8 rounded-[2rem] border border-border flex items-start gap-6 group hover:shadow-xl transition-all duration-700">
                                ...
                                <div>
                                    ...
                                    <a href="https://maps.google.com/maps?q=Jalan%20Sungai%20Balang,%20Kota%20Padang" className="text-primary font-bold text-[11px] uppercase tracking-widest flex items-center gap-2 hover:gap-3 transition-all font-sans" target="_blank" rel="noreferrer">
            ...
            {/* Map Section */}
            <div className="w-full h-[500px] relative mt-32 border-t border-border">
                <iframe 
