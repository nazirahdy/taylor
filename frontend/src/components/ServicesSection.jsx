...
const ServicesSection = () => {
    ...
    return (
        <section className="bg-white py-8 scroll-mt-8" id="services">
            <div className="container mx-auto px-4 md:px-12 text-center mb-8 animate-fade-in">
                <span className="text-primary uppercase tracking-[0.4em] text-[11px] font-bold mb-4 block font-sans">Keahlian Kami</span>
                <h2 className="text-3xl md:text-2xl font-display font-bold mb-5 text-text-primary">Layanan Jahit</h2>
