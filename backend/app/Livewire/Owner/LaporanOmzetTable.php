...
class LaporanOmzetTable extends Component implements HasForms, HasTable
{
    ...
    {
        return $table
            ->query(Order::query()->where('status', 'selesai_penyerahan')->with('user'))
            ->columns([
                ...
                TextColumn::make('estimated_price')->money('IDR', locale: 'id')->label('Omzet (Rp)')->sortable(),
